<?php
//2. Реализовать решение задачи #3 из практического задания №2
// (пропущенное число в цепочке), упростив сложность до O(logn)
// при помощи парадигмы "Разделяй и властвуй" (бинарный поиск)
